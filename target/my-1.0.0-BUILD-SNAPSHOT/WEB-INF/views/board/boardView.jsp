    			...
    			<tbody>
				    <c:forEach items="${boardList}" var="board">
				        <tr>
    						...
    						<td style="text-align: center; width: 10%; border: 1px solid #ddd;">${board.memNm}</td>
    						<td style="text-align: center; width: 10%; border: 1px solid #ddd;">${board.updateDt}</td>
    						<td style="text-align: center; width: 10%; border: 1px solid #ddd;">999</td>
				        </tr>
				    </c:forEach>
				</tbody>
    		</table>
